...
<head>
	...
	<script src="<?= base_url() ?>diseño/js/registro.js"></script>
					...
					<div class="card">
						...
						<div class="card-body">
							...
							<div class="form-group">
								...
								<input type="email" id="correo" name="password" class="form-control" required>
							</div>

							<div class="form-group">
								<label for="exampleInputPassword1">Teléfono*</label>
								<input type="tel" id="telefono" name="password" class="form-control" required>
							</div>
							...
							<div class="card-footer">
								<button style="background-color: #f6ae2d" id="btn-registro" type="submit" class="btn text-white"><i class="fas fa-external-link-alt"></i>&nbsp;Insertar</button>
							</div>
