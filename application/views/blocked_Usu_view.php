...
<head>
	...
	<script src="<?= base_url() ?>diseño/js/lista_admins_inactive.js"></script>
...
<div class="content-wrapper">
	...
	<div class="content-header">
		<div class="container-fluid">
			<div class="row mb-2">
				<div class="col-sm-6">
					<h1 class="m-0">Lista de Usuarios inactivos</h1>
				</div><!-- /.col -->
				<div class="col-sm-6">
				...
				<div class="col-12">
					<div class="card">
						<div class="card-header" style="background-color: #2f4858">
							<h3 class="card-title text-white">Usuarios Inactivos</h3>
						</div>
						<!-- /.card-header -->
...
<!-- Modal BORRAR -->
<div class="modal fade" id="modal-activar" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body" style="background-color: #EBE6E6">
				¿Seguro que desea activar al usuario<span id="modal-borrar-usuario"></span> nuevamente?
			</div>
