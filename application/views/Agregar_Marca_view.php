...
<head>
	...
	<script src="<?= base_url() ?>diseño/js/agregar_marc.js"></script>
     ...
     <div class="card">
      ...
      <div class="card-body">
       <div class="form-group">
        ...
        <input type="text" id="nombre_marc" name="nombre_marc" class="form-control" required>
      </div>

      <div class="form-group">
        <label for="exampleInputEmail1">Descripción de la Marca</label>
        <textarea type="text" id="descr_marc" name="descr_marc" class="form-control" cols="40"></textarea>
      </div>
      
      <!-- /.card-body -->
      <div class="card-footer">
        <button style="background-color: #f6ae2d" id="btn-agregar-marc" type="submit" class="btn text-white"><i class="fas fa-external-link-alt"></i>&nbsp;Agregar</button>
      </div>
