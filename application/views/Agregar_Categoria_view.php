...
<head>
	...
	<script src="<?= base_url() ?>diseño/js/agregar_cat.js"></script>
    ...
    <div class="content-wrapper">
     ...
     <div class="content-header">
      <div class="container-fluid">
       <div class="row mb-2">
        <div class="col-sm-6">
         <h1 class="m-0">Agregar Categoría</h1>
       </div><!-- /.col -->
       <div class="col-sm-6">
    ...
    <div class="col-md-9">
     ...
     <div class="card-body">
       <div class="form-group">
        ...
        <input type="text" id="nombre_cat" name="nombre_cat" class="form-control" required>
      </div>

      <div class="form-group">
        <label for="exampleInputEmail1">Descripción de la categoría</label>
        <textarea type="text" id="descr_cat" name="descr_cat" class="form-control" cols="40"></textarea>
      </div>
      
      <!-- /.card-body -->
      <div class="card-footer">
        <button style="background-color: #f6ae2d" id="btn-agregar-cat" type="submit" class="btn text-white"><i class="fas fa-external-link-alt"></i>&nbsp;Agregar</button>
      </div>
