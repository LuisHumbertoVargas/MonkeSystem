...
<head>
	...
	<script src="<?= base_url() ?>diseño/js/cancel_request_list.js"></script>
...
<div class="content-wrapper">
	...
	<div class="content-header">
		<div class="container-fluid">
			<div class="row mb-2">
				<div class="col-sm-6">
					<h1 class="m-0">Solicitudes Canceladas</h1>
				</div><!-- /.col -->
				<div class="col-sm-6">
				...
				<div class="col-12">
					<div class="card">
						<div class="card-header" style="background-color: #2f4858">
							<h3 class="card-title text-white">Solicitudes Canceladas</h3>
						</div>
						<!-- /.card-header -->
							...
							<table id="tabla-admins" class="table table-striped">
								<thead>
									<tr class='thead-dark'>
										...
										<th class="text-center text-white">Atendió</th>
...
<footer class="main-footer">
	<strong>Copyright &copy;2020 <a href="https://adminlte.io">CotizApp</a>.</strong>
	All rights reserved.
	...
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header" style="background-color: #000">
				<h5 class="modal-title text-white" id="exampleModalLabel">Desactivar Servicio</h5>
				<button type="button" class="close text-white" data-dismiss="modal" aria-label="Close">
					<span aria-hidden="true">&times;</span>
				</button>
			</div>
			<div class="modal-body" style="background-color: #EBE6E6">
				¿Seguro que desea desactivar el Servicio<span id="modal-borrar-servicio
				"></span>?
			</div>
			<div class="modal-footer">
				...
				data-dismiss="modal"
				class="btn text-white"
				style="background-color: #A01127" 
				data-cvecli=""
				id="btn-confirmar-baja-serv">
