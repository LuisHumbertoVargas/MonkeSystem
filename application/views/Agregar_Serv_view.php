...
<head>
 ...
 <script src="<?= base_url() ?>diseño/js/agregar_serv.js"></script>
    ...
    <div class="col-md-9">
     ...
     <div class="card-body">
       <div class="form-group">
        ...
        <input type="text" id="nombre_prod" name="nombre_prod" class="form-control" required>
      </div>

      <div class="form-group">
        <label for="exampleInputEmail1">Descripción de Producto</label>
        <textarea type="text" id="descr_prod" name="descr_prod" class="form-control" cols="40"></textarea>
      </div>

      <div class="form-group">
        <label for="exampleInputEmail1">Cantidad</label>
        <input type="number" id="cantidad" name="cantidad" class="form-control" placeholder="0" step="1" min="0" max="999999"required>
      </div>

      <div class="form-group">
        <label for="exampleInputEmail1">Precio de Producto</label>
        <input type="number" id="precio_venta" name="precio_venta" class="form-control" placeholder="0.0" step="0.50" min="0" max="99999999.99"required>
      </div>

      <div class="form-group">
        <label for="exampleInputEmail1">Costo de Producto</label>
        <input type="number" id="precio_compra" name="precio_compra" class="form-control" placeholder="0.0" step="0.50" min="0" max="99999999.99"required>
      </div>
      ...
      <div class="card-footer">
        <button style="background-color: #f6ae2d" id="btn-agregar-serv" type="submit" class="btn text-white"><i class="fas fa-external-link-alt"></i>&nbsp;Agregar</button>
      </div>
