    ...
    <div class="content-wrapper">
      ...
      <div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1 class="m-0">Modificación Marca</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="<?= base_url() ?>inicio/marcas">Marca</a></li>
            ...
            <div class="col-md-9">
              ...
              <div class="card">
                ...
                foreach ($resultado as $key) { 
                  echo "
                  <form id='quickForm' action='".base_url()."inicio/modificarMarca/".$key->id_marc."' method='get'>
                  <div class='card-body'>
                  <div class='form-group'>
                  <label for='exampleInputEmail1'>Nombre de la marca</label>
                  <input type='text' name='nombre_marc' value='".$key->nombre_marc."' class= 'form-control'> 
                  </div>
                  <div class='form-group'>
                  <label for='exampleInputEmail1'>Descripción</label>
                  <textarea type='text' name='descr_marc' cols='40'
                  class='form-control'>".$key->descr_marc."</textarea>
                  </div>
                  <div class='form-group'>
                  <label for='exampleInputPassword1'>ID de la marca</label>
                  <input type='email' name='id_marc' readonly 
                  value='".$key->id_marc."' class='form-control'>
                  </div>
                  <div class='form-group mb-12'>
                  <div class='form-group'>
                  <label for='exampleInputEmail1'>Estado de la marca</label>
                  <select name='estado_marc' class='custom-select form-control-border border-width-2' id='exampleSelectBorderWidth2'>
                  <option value='1' "; if ($key->estado_marc == 1): echo 'selected="selected"'; endif; echo">Habilitado</option>
                  <option value='0' "; if ($key->estado_marc == 0): echo 'selected="selected"'; endif; echo">Deshabilitado</option>
                  </select>
                  </div>
                  <div class='form-group mb-12'>
