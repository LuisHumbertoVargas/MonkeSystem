    ...
    <div class="content-wrapper">
      ...
      <div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1 class="m-0">Modificación Usuario</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="<?= base_url() ?>inicio/modificacion">Usuario</a></li>
            ...
            <div class="col-md-9">
              ...
              <div class="card">
                ...
                foreach ($resultado as $key) { 
                  echo "
                  <form id='quickForm' action='".base_url()."inicio/modificarAdm/".$key->correo."' method='get'>
                  <div class='card-body'>
                  <div class='form-group'>
                  <label for='exampleInputEmail1'>Nombre(s)</label>
                  <input type='text' name='nombre' value='".$key->nombre."' class= 'form-control'> 
                  </div>
                  <div class='form-group'>
                  <label for='exampleInputEmail1'>Apellido(s)</label>
                  <input type='text' name='apellidos' 
                  value='".$key->apellidos."' class='form-control'>
                  </div>
                  <div class='form-group'>
                  <label for='exampleInputPassword1'>telefono</label>
                  <input type='number' name='telefono' readonly 
                  value='".$key->telefono."' class='form-control'>
                  </div>
                  <div class='form-group'>
                  <label for='exampleInputPassword1'>Correo Electrónico</label>
                  <input type='email' name='correo' readonly 
                  value='".$key->correo."' class='form-control'>
                  </div>
                  <div class='form-group'>
                  ...
                  <select name='estado' class='custom-select form-control-border border-width-2' id='exampleSelectBorderWidth2'>
                  <option value='1' "; if ($key->estado == 1): echo 'selected="selected"'; endif; echo">Habilitado</option>
                  <option value='0' "; if ($key->estado == 0): echo 'selected="selected"'; endif; echo">Deshabilitado</option>
                  </select>
                  </div>
                  <div class='form-group'>
                  <label for='exampleInputEmail1'>Tipo de empleado</label>
                  <select name='rol' class='custom-select form-control-border border-width-2' id='exampleSelectBorderWidth2'>
                  <option value='1' "; if ($key->rol == 1): echo 'selected="selected"'; endif; echo">administrador</option>
                  <option value='0' "; if ($key->rol == 0): echo 'selected="selected"'; endif; echo">empleado</option>
                  </select>
                  </div>
                  <div class='form-group mb-12'>
