...
<head>
	...
	<script src="<?= base_url() ?>diseño/js/lista_type_serv.js"></script>
...
<div class="content-wrapper">
	...
	<div class="content-header">
		<div class="container-fluid">
			<div class="row mb-2">
				<div class="col-sm-6">
					<h1 class="m-0">Tipo de servicios</h1>
				</div><!-- /.col -->
				<div class="col-sm-6">
				...
				<div class="col-12">
					<div class="card">
						<div class="card-header" style="background-color: #2f4858">
							<h3 class="card-title text-white">Categorias</h3>
						</div>
						<!-- /.card-header -->
	...
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header" style="background-color: #000">
				<h5 class="modal-title text-white" id="exampleModalLabel">Desactivar Categoria</h5>
				<button type="button" class="close text-white" data-dismiss="modal" aria-label="Close">
					<span aria-hidden="true">&times;</span>
				</button>
			</div>
			<div class="modal-body" style="background-color: #EBE6E6">
				¿Seguro que desea desactivar la categoria<span id="modal-borrar-categoria
				"></span>?
			</div>
