...
<head>
	...
	<script src="<?= base_url() ?>diseño/js/lista_serv_inactive.js"></script>
	...
	<section class="content">
		<div class="container-fluid">
				...
				<div class="col-12">
					<div class="card">
						<div class="card-header" style="background-color: #2f4858">
							<h3 class="card-title text-white">Productos inactivos</h3>
						</div>
						<!-- /.card-header -->
							...
							<table id="tabla-admins" class="table table-striped">
								<thead>
									<tr class='thead-dark'>
										...
										<th class="text-center text-white">Costo</th>
            ...
            # code...
										...
										<td class='text-center'> 
										<a href='".base_url()."inicio/modificaUsu/".$key->Mail_Us."''>
										...
										&nbsp;&nbsp;
										<a href='".base_url()."inicio/borraUsuario/".$key->Mail_Us."''>
...
<!-- Modal BORRAR -->
<div class="modal fade" id="modal-activar-serv" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header" style="background-color: #000">
				<h5 class="modal-title text-white" id="exampleModalLabel">Activar servicio</h5>
				<button type="button" class="close text-white" data-dismiss="modal" aria-label="Close">
					<span aria-hidden="true">&times;</span>
				</button>
			</div>
			<div class="modal-body" style="background-color: #EBE6E6">
				¿Seguro que desea activar el servicio <span id="modal-activar-serv
				"></span>nuevamente?
			</div>
