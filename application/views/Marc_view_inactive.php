...
<head>
	...
	<script src="<?= base_url() ?>diseño/js/lista_marc_inactive.js"></script>
...
<div class="content-wrapper">
	...
	<div class="content-header">
		<div class="container-fluid">
			<div class="row mb-2">
				<div class="col-sm-6">
					<h1 class="m-0">Marcas Inactivas</h1>
				</div><!-- /.col -->
				<div class="col-sm-6">
				...
				<div class="col-12">
					<div class="card">
						<div class="card-header" style="background-color: #2f4858">
							<h3 class="card-title text-white">Marcas inactivas</h3>
						</div>
						<!-- /.card-header -->
							...
							<table id="tabla-admins" class="table table-striped">
								<thead>
									<tr class='thead-dark'>
										...
										<th class="text-center text-white">Marcas</th>
...
<!-- Modal BORRAR -->
<div class="modal fade" id="modal-activar-marca" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header" style="background-color: #000">
				<h5 class="modal-title text-white" id="exampleModalLabel">Activar marca</h5>
				<button type="button" class="close text-white" data-dismiss="modal" aria-label="Close">
					<span aria-hidden="true">&times;</span>
				</button>
			</div>
			<div class="modal-body" style="background-color: #EBE6E6">
				¿Seguro que desea activar la marca nuevamente<span id="modal-activar-marca
				"></span>?
			</div>
