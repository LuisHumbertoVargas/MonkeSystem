    ...
    <div class="content-wrapper">
      ...
      <div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1 class="m-0">Modificación Categoria</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="<?= base_url() ?>inicio/categorias">Categoria</a></li>
            ...
            <div class="col-md-9">
              ...
              <div class="card">
                ...
                foreach ($resultado as $key) { 
                  echo "
                  <form id='quickForm' action='".base_url()."inicio/modificarCategoria/".$key->id_cat."' method='get'>
                  <div class='card-body'>
                  <div class='form-group'>
                  <label for='exampleInputEmail1'>Nombre de la categoria</label>
                  <input type='text' name='nombre' value='".$key->nombre_cat."' class= 'form-control'> 
                  </div>
                  <div class='form-group'>
                  <label for='exampleInputEmail1'>Descripción</label>
                  <textarea type='text' name='descr_cat' cols='40'
                  class='form-control'>".$key->descr_cat."</textarea>
                  </div>
                  <div class='form-group'>
                  <label for='exampleInputPassword1'>ID de la categoria</label>
                  <input type='email' name='id_cat' readonly 
                  value='".$key->id_cat."' class='form-control'>
                  </div>
                  <div class='form-group mb-12'>
                  <div class='form-group'>
                  <label for='exampleInputEmail1'>Estado de la categoria</label>
                  <select name='estado_cat' class='custom-select form-control-border border-width-2' id='exampleSelectBorderWidth2'>
                  <option value='1' "; if ($key->estado_cat == 1): echo 'selected="selected"'; endif; echo">Habilitado</option>
                  <option value='0' "; if ($key->estado_cat == 0): echo 'selected="selected"'; endif; echo">Deshabilitado</option>
                  </select>
                  </div>
                  <div class='form-group mb-12'>
