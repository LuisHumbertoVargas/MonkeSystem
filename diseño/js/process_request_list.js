			...
			if (obj.resultado) {
				...
				$.each(obj.Request,function(i,p){
					tabla.append('<tr>'+
						...
						'<a href="http://localhost/CotizApp/inicio/mostrarSoli/'+p.id_soli+'"><button id="btn-mostrar"class="btn text-white" style="background-color:#33658A"type="submit"><i class="fas fa-eye text-white text-center"></i></button></a>'+
